  ...
  Future<Map<int, int>> _getQuestionCounts(String subject) async {
    try {
      ...
      if (subjectLower == 'computer' || subjectLower == 'tech') {
        ...
        result[1] = 85; // บทที่ 1 มี 85 ข้อ
        result[2] = 75; // บทที่ 2 มี 75 ข้อ
        result[3] = 65; // บทที่ 3 มี 65 ข้อ
        result[4] = 70; // บทที่ 4 มี 70 ข้อ
        result[5] = 55; // บทที่ 5 มี 55 ข้อ
        result[6] = 60; // บทที่ 6 มี 60 ข้อ
        result[7] = 50; // บทที่ 7 มี 50 ข้อ
        result[8] = 45; // บทที่ 8 มี 45 ข้อ
        result[9] = 40; // บทที่ 9 มี 40 ข้อ
        result[10] = 35; // บทที่ 10 มี 35 ข้อ
        // รวมทั้งหมด: 580 ข้อ
      }
